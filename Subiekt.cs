...
namespace HurtonToSubiektDesktop
{
    ...
    internal class Subiekt
    {
        ...
        public static void UpdateOrInsertAssortmentsByCatalog(ProductsXML.Product[] products)
        {
            ...
            var podmiot = menedzerPodmiotow.Dane.Wszystkie().FirstOrDefault(a => a.NIP == Hurton.NIP);
            IPodmiot hurton;
            if(podmiot == null)
            {
                hurton = menedzerPodmiotow.Utworz();
                hurton.Dane.NIP = Hurton.NIP;
                hurton.Zapisz();
            ...
            JednostkaMiary sztuka = menedzerJednostekMiar.DaneDomyslne.Sztuka;
            ...
            foreach (var product in products)
            {
                ...
                try
                {
                    ...
                    if (found != null)
                    {
                        ...
                        asortyment = menedzerAsortymentow.Znajdz(found.element);
                    }
                    else
                    {
                        if (Syncs.OnlyUpdateExists)
                        {
                            skipped_count++;
                            continue;
                        }

                        asortyment = menedzerAsortymentow.Utworz();

                        asortyment.Dostawcy.Dodaj(podmiot);

                        asortyment.JednostkiMiary.DodajPodstawowaJednostkeMiary(sztuka);
                    }
                    ...
                    {
                        foreach (var encjaZBledami in asortyment.Bledy)
                        {
